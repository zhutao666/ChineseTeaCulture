  ...
  <tr>
   ...
   <div class="menu">
    <table width="100%"  border="0" cellpadding="0" cellspacing="0">
     <tr >
      <td height="25" class="tttitle"><a href="javascript: d.openAll();"><img src="images/view_detailed.gif" width="15" height="15" border="0" align="absmiddle" alt="展开列表"></a> <a href="javascript: d.closeAll();"><img src="images/view_tree.gif" width="15" height="15" border="0" align="absmiddle" alt="收缩列表"></a><a href="right.php" target="mainFrame" class="ttitle">系统首页</a>|<a href="../index.php" target="_blank" class="ttitle">网站首页</a></td>
     </tr>
     <tr>
      <td>
